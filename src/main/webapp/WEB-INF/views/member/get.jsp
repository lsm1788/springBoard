				...
				<div class="widget p-lg">
					...
					<div class="panel-body">
						...
						<input type="hidden" name="num" id="num" value="${member.num}">
							...
							<div class="form-group">
								<label>학교명</label><input type="text" name="schoolname" id="schoolname" class="form-control" value="${member.schoolname}" required="required">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>노선</label><input type="text" name="route" id="route" class="form-control" value="${member.route}" required="required">
							</div>
							<div class="form-group">
								<label>탑승장소</label><input type="text" name="boardingplace" id="boardingplace" class="form-control" value="${member.boardingplace}" required="required">
							</div>
							<div class="form-group">
